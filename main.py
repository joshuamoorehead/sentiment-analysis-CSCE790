...
sentiment_prediction = torch.tensor([-1])

# TODO: run multimodal expresion recognition
#final = late_fusion_model('happiness', 1)
lf_model = late_fusion_model()
final = lf_model(sentiment_prediction, 'happiness')
